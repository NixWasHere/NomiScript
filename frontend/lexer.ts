import { handleError, LexerError } from "../runtime/handler.ts";
	...
	while (src.length > 0) {
		...
		// Handle Conditional & Assignment Tokens
			...
			if (src[0] == '"') {
				...
				console.error("Unclosed string literal");
				Deno.exit(1);
			}
		}
		// HANDLE MULTICHARACTER KEYWORDS, TOKENS, IDENTIFIERS ETC...
			...
			// TODO: Impliment better errors and error recovery.
				...
				handleError(new LexerError("Unrecognized character found in source."));
			}
		}
	}
